...
$expectedTargets = @(
  [ordered]@{target_id="f210";factorio_line="2.1";import_successor_target="MIR4-R0/2.1";predecessor_release="3.2.11"},
  [ordered]@{target_id="f200";factorio_line="2.0";import_successor_target="MIR4-R0/2.0";predecessor_release="2.5.11"},
