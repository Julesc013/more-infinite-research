...
$receipt=[pscustomobject][ordered]@{
  ...
  evolved_bindings=@(
    ...
    [pscustomobject][ordered]@{path='tests/mir4/Test-MIR4ReleaseAdaptersT05.ps1';previous_sha256='2D7EA6EB31F13F50F9B01E8090AA474B64D9FB44368DEF60582F4590CFCB6D2E';current_sha256=(Get-MIR4M4202BaseTextSha256 'tests/mir4/Test-MIR4ReleaseAdaptersT05.ps1');hash_mode='canonical-text-v1';package_visible=$false;release_authority=$false}
