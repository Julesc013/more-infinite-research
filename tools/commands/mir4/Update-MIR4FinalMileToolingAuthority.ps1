...
$roles = [ordered]@{
  ...
  'tools/lib/assurance/Core.ps1' = 'final-mile-assurance-v4-core'
  'tools/lib/assurance/Domains.ps1' = 'final-mile-assurance-v4-domains'
  'tools/lib/assurance/Hashing.ps1' = 'final-mile-assurance-v4-hashing'
