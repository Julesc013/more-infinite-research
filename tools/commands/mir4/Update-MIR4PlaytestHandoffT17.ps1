...
$roles = [ordered]@{
  ...
  'docs/RELEASE-RUNBOOK.md' = 't17-release-runbook'
  ...
  'sdk/preview/mir4/reference/compilation-runs.json' = 't17-platform-compilation-projection'
  'sdk/preview/mir4/reference/inspection-bundle-v1.json' = 't17-platform-inspection-projection'
  'sdk/preview/mir4/reference/inspector-workbench-result-v1.json' = 't17-platform-workbench-projection'
  'sdk/preview/mir4/reference/query-snapshot-f210.json' = 't17-platform-query-projection'
