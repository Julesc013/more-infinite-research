...
$expectedPaths=@(
  ...
  'targets/f100/generation/README.md.template',
  'targets/f100/generation/changelog.txt.template',
  'targets/f100/overlay.json',
  'targets/f110/generation/README.md.template',
  'targets/f110/generation/changelog.txt.template',
  'targets/f110/overlay.json',
  'targets/f200/generation/README.md.template',
  'targets/f200/generation/changelog.txt.template',
  'targets/f200/overlay.json',
  'targets/f210/generation/README.md.template',
  'targets/f210/generation/changelog.txt.template',
  'targets/f210/overlay.json',
