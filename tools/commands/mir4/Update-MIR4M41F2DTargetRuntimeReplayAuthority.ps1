...
if ($Check) {
  ...
  Require-MIR4F2DTarget ([string]$proof.predecessor.version -ceq [string]$baseline.predecessor -and [string]$proof.predecessor.archive_sha256 -ceq (Get-MIR4F2DTargetFileSha256 $predecessorArchive)) 'mir4-m41-f2d-target-predecessor-identity'
