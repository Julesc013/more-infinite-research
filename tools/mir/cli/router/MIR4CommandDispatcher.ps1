function Invoke-MIR4CommandDispatch {
  ...
  $applicationCommands = @('environment-evidence','assurance-scale','release-governance','release-engine','tooling','patch-rehearsal','release-narratives','repository','factorio-2.1-channel','package-source','distribution')
