...
Usage:
  ...
  .\tools\mir.ps1 storage audit [--artifact-type <result|test|package|campaign>[,...]] [--all-worktrees] [--older-than-days <days>]
  .\tools\mir.ps1 storage clean [--artifact-type <result|test|package|campaign>[,...]] [--all-worktrees] [--older-than-days <days>] --apply
