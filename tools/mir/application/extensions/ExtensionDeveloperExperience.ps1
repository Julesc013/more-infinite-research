...
& (Join-Path $sdk 'tools/mir/cli/Invoke-MIR4Extension.ps1') -Command doctor -RepoRoot $sdk -ExtensionPath $extension | Out-Null
& (Join-Path $sdk 'tools/mir/cli/Invoke-MIR4Extension.ps1') -Command validate -RepoRoot $sdk -ExtensionPath $extension | Out-Null
& (Join-Path $sdk 'tools/mir/cli/Invoke-MIR4Extension.ps1') -Command test -RepoRoot $sdk -ExtensionPath $extension | Out-Null
'@
