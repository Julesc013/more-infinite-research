...
function New-MIRCPTodoLines {
  ...
  $lines.Add("| ``325-D1`` narrowed freeze packet | Prepared for governed admission | Exact revision-5 lineage, package composition, bounded product/target contracts, environment/privacy/localization/performance/manual authorities, release documents, and source-bound plan are reviewable before C32 assignment |")
