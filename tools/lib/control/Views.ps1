...
function New-MIRCPTodoLines {
  ...
  $lines.Add("| ``325-B1`` essential research-cost correctness | Implemented locally; governed admission pending | Exact committed-head local and hosted proof admits the algebraic/numeric/parser contract, 3.2.3 defaults, ownership dispositions, all transitions, and first/second reload equivalence |")
