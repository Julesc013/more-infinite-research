...
function Get-MIR4FullPlatformBlockers {
  return @(
    ...
    [pscustomobject][ordered]@{id='BLOCKED-EXACT-ARCHIVE-CUSTODY-F200-K2SO';scope=@('f200-k2so-exact-processir-preview');owner='historical-mod-archive-custody';required_input='The four exact retained F200 K2SO dependency archives identified by the T12 custody blocker.';workaround_permitted=$false},
