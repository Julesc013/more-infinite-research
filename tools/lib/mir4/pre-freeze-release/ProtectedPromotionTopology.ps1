...
function Read-MIR4A08QualificationRecord {
  ...
  foreach ($row in @($record.targets)) {
    ...
    Assert-MIR4A08QualificationReceipts -Row $row -Candidate $Candidate -Authority $authority -Observed $actual
    $observed+=$actual
  }
