...
local STREAM_EXTRA_PACKS = {
  ...
  research_artificial_soil = {"agricultural-science-pack"},
  ...
  research_oil_processing_productivity = {"space-science-pack"},
  research_oil_cracking_productivity = {"space-science-pack"},
  research_lubricant_productivity = {"space-science-pack"},
  research_sulfuric_acid_productivity = {"space-science-pack"},
  research_bacteria_cultivation = {"agricultural-science-pack"},
