...
function M.technology_overlay_layer()
  ...
  -- technology constant badge assets or a documented native modifier icon
  -- surface. Keep generated technologies on single target-era technology art
  -- instead of bundling or simulating newer badge graphics.
  return false
end
