...
for _, claim in ipairs(M.claims) do
  if not claim.maturity or not claim.behavior or not claim.scope then
    error("Compatibility claim lacks independent dimensions: " .. tostring(claim.id))
  end
