...
data:extend({
  ...
  },
  {
    ...
    data = {packs = {["mir-upgrade-automatic-family"] = {
      schema = 2,
      id = "mir-upgrade-automatic-family",
      applicability = {mods = {{id = "mir-fixture-assert-upgrade-2-5-10-to-2-5-11", version = "= 0.1.0"}}},
      aliases = {}, exact = {includes = {}, excludes = {}}, family_hints = {}, science_roles = {},
      owner_claims = {}, risk_overrides = {},
