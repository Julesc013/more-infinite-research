...
local function fail(message)
  error("MIR 3.1.9 to 3.2.0 verification-overhaul upgrade validation failed: " .. message)
end
...
script.on_init(function()
  ...
  log("[mir-fixture] 3.1.9 upgrade source proof complete")
end)
...
script.on_configuration_changed(function()
  ...
  log("[mir-fixture] 3.1.9 to 3.2.0 upgrade proof complete")
end)
