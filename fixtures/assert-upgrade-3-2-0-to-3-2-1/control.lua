...
local function fail(message)
  error("MIR 3.2.0 to 3.2.1 " .. archetype .. " upgrade validation failed: " .. message)
end
...
script.on_init(function()
  ...
  if script.active_mods["more-infinite-research"] ~= "3.2.0" then
    fail("initial save did not use MIR 3.2.0")
  end
  assert_settings()
  ...
  log("[mir-fixture] 3.2.0 upgrade source proof complete archetype=" .. archetype)
end)

script.on_configuration_changed(function()
  if script.active_mods["more-infinite-research"] ~= "3.2.1" then
    fail("upgraded save did not use MIR 3.2.1")
  end
  assert_settings()
  ...
  log("[mir-fixture] 3.2.0 to 3.2.1 upgrade proof complete archetype=" .. archetype)
end)
