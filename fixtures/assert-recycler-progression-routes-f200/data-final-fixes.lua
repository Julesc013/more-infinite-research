...
local function fail(message)
  error("MIR Factorio 2.0 Recycler Progression route assertion failed: " .. message)
end
...
if exercised > 0 and exercised < 6 then
...
log("[mir-fixture-assert-recycler-progression-routes-f200] PASS recycler-1-routes-rejected=true"
  .. " surface-present=" .. tostring(exercised > 0) .. " exercised=" .. tostring(exercised))
