local from_version = "1.9.4"
local to_version = "1.9.5"
...
local function fail(message)
  error("MIR 1.9.4 to 1.9.5 retention validation failed: " .. message)
end
...
script.on_init(function()
  ...
  log("[mir-fixture] 1.9.4 upgrade source proof complete")
end)
...
script.on_configuration_changed(function()
  ...
  log("[mir-fixture] 1.9.4 to 1.9.5 upgrade proof complete")
end)
