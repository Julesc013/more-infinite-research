local from_version = "1.4.5"
local to_version = "1.4.9"
local technology_name = "recipe-prod-research_rocket_shooting_speed-1"
local expected_progress = 0.42
local epsilon = 0.000001

local function fail(message)
  error("MIR 1.4.5 to 1.4.9 retention validation failed: " .. message)
end
...
script.on_init(function()
  ...
  game.server_save("mir-1.4.5-save")
  log("[mir-fixture] 1.4.5 upgrade source proof complete")
end)
...
script.on_configuration_changed(function()
  ...
  log("[mir-fixture] 1.4.5 to 1.4.9 upgrade proof complete")
end)
