local from_version = "1.7.1"
local to_version = "1.7.5"
...
local function fail(message)
  error("MIR 1.7.1 to 1.7.5 retention validation failed: " .. message)
end
...
script.on_init(function()
  ...
  global.mir.target_upgrade_fixture = {
    ...
    runtime_marker = "factorio-0.17-global-state"
  }
  game.server_save("mir-1.7.1-save")
  log("[mir-fixture] 1.7.1 upgrade source proof complete")
end)
...
script.on_configuration_changed(function()
  ...
  if not state or state.runtime_marker ~= "factorio-0.17-global-state" then
  ...
  log("[mir-fixture] 1.7.1 to 1.7.5 upgrade proof complete")
end)
