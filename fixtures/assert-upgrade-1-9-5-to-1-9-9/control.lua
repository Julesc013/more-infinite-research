local from_version = "1.9.5"
local to_version = "1.9.9"
...
local function fail(message)
  error("MIR 1.9.5 to 1.9.9 retention validation failed: " .. message)
end
...
script.on_init(function()
  ...
  log("[mir-fixture] 1.9.5 upgrade source proof complete")
end)
...
script.on_configuration_changed(function()
  ...
  log("[mir-fixture] 1.9.5 to 1.9.9 upgrade proof complete")
end)
