local from_version = "1.8.2"
local to_version = "1.8.9"
...
local function fail(message)
  error("MIR 1.8.2 to 1.8.9 retention validation failed: " .. message)
end
...
script.on_init(function()
  ...
  log("[mir-fixture] 1.8.2 upgrade source proof complete")
end)
...
script.on_configuration_changed(function()
  ...
  log("[mir-fixture] 1.8.2 to 1.8.9 upgrade proof complete")
end)
