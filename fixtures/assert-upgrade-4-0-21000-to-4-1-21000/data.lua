...
data:extend({entity,{
  type="item",name="mir-upgrade-auto-assembler",icon="__base__/graphics/icons/assembling-machine-2.png",icon_size=64,
  subgroup="production-machine",order="zzz-mir-upgrade-auto-assembler",place_result="mir-upgrade-auto-assembler",stack_size=50
},{
  type="recipe",name="mir-upgrade-auto-assembler-recipe",enabled=true,
  ingredients={{type="item",name="electronic-circuit",amount=1}},results={{type="item",name="mir-upgrade-auto-assembler",amount=1}},allow_productivity=true
},{
  type="mod-data",name="more-infinite-research-compatibility-pack",data={packs={["mir-upgrade-automatic-family"]={
    ...
    targets={factorio_lines={"2.1"}},evidence={fixtures={"upgrade-matrix-automatic-family"},real_mod={}},claim={level="fixture-only",public=false}
  }}}
}})
