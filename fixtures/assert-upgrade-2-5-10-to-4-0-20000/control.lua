local from_version = "2.5.10"
local to_version = "4.0.20000"
...
script.on_init(function()
  ...
  storage.mir_local_playtest_upgrade = {
...
script.on_configuration_changed(function()
  ...
  local state = storage.mir_local_playtest_upgrade
...
script.on_event(defines.events.on_tick, function()
  ...
  if state and state.upgrade_complete and not state.server_save_requested then
    ...
    game.server_save("mir-4020000-upgraded")
  end
end)

script.on_load(function()
  if storage.mir_local_playtest_upgrade and storage.mir_local_playtest_upgrade.upgrade_complete then
