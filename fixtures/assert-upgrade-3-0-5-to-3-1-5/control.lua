...
local function fail(message)
  error("MIR 3.0.5 to 3.1.5 upgrade validation failed: " .. message)
end
...
script.on_configuration_changed(function()
  if script.active_mods["more-infinite-research"] ~= "3.1.5" then
    fail("upgraded save did not use MIR 3.1.5")
  end
  ...
  log("[mir-fixture] 3.0.5 to 3.1.5 upgrade proof complete")
end)
