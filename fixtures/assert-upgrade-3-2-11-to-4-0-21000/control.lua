local from_version = "3.2.11"
local to_version = "4.0.21000"
...
script.on_event(defines.events.on_tick,function() local state=storage.mir_upgrade_fixture;if state and state.upgrade_complete and not state.server_save_requested then state.server_save_requested=true;game.server_save("mir-4021000-upgraded") end end)
