...
local function fail(message)
  error("MIR 3.0.5 to 3.1.0 automatic compiler upgrade validation failed: " .. message)
end
...
script.on_init(function()
  ...
  log("[mir-fixture] 3.0.5 automatic compiler upgrade source proof complete")
end)
...
script.on_configuration_changed(function()
  ...
  log("[mir-fixture] 3.0.5 to 3.1.0 automatic compiler upgrade proof complete")
end)
