...
local function fail(message)
  error("MIR 2.4.9 to 2.5.0 " .. archetype .. " upgrade validation failed: " .. message)
end
...
script.on_init(function()
  ...
  if script.active_mods["more-infinite-research"] ~= "2.4.9" then
    fail("initial save did not use MIR 2.4.9")
  end
  assert_settings()
  ...
  log("[mir-fixture] 2.4.9 upgrade source proof complete archetype=" .. archetype)
end)
...
script.on_configuration_changed(function()
  ...
  log("[mir-fixture] 2.4.9 to 2.5.0 upgrade proof complete archetype=" .. archetype)
end)
