...
local function fail(message)
  error("MIR 2.4.9 to 2.5.0 native-owner upgrade validation failed: " .. message)
end
...
script.on_init(function()
  ...
  log("[mir-fixture] 2.4.9 upgrade source proof complete")
end)
...
script.on_configuration_changed(function()
  ...
  log("[mir-fixture] 2.4.9 to 2.5.0 upgrade proof complete")
end)
