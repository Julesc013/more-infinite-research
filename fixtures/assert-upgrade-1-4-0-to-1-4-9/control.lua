...
local function fail(message)
  error("MIR 1.4.0 to 1.4.9 retention validation failed: " .. message)
end
...
script.on_init(function()
  ...
  game.server_save("mir-1.4.0-save")
  log("[mir-fixture] 1.4.0 upgrade source proof complete")
end)
...
script.on_configuration_changed(function()
  ...
  log("[mir-fixture] 1.4.0 to 1.4.9 upgrade proof complete")
end)
