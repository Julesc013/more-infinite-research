local from_version = "1.3.5"
local to_version = "1.3.9"
local technology_name = "recipe-prod-research_rocket_shooting_speed-1"
local expected_progress = 0.42
local epsilon = 0.000001

local function fail(message)
  error("MIR 1.3.5 to 1.3.9 retention validation failed: " .. message)
end
...
script.on_init(function()
  ...
  log("[mir-fixture] 1.3.5 upgrade source proof complete")
end)
...
script.on_configuration_changed(function()
  ...
  log("[mir-fixture] 1.3.5 to 1.3.9 upgrade proof complete")
end)
