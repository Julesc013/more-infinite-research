...
local function fail(message)
  error("MIR 2.5.0 to 2.5.5 " .. archetype .. " upgrade validation failed: " .. message)
end
...
script.on_init(function()
  ...
  if script.active_mods["more-infinite-research"] ~= "2.5.0" then
    fail("initial save did not use MIR 2.5.0")
  end
  assert_settings()
  ...
  log("[mir-fixture] 2.5.0 upgrade source proof complete archetype=" .. archetype)
end)

script.on_configuration_changed(function()
  if script.active_mods["more-infinite-research"] ~= "2.5.5" then
    fail("upgraded save did not use MIR 2.5.5")
  end
  assert_settings()
  local state = storage.mir_upgrade_fixture
  log("[mir-fixture] upgraded storage archetype=" .. archetype
    .. " present=" .. tostring(state ~= nil)
    .. " stored_archetype=" .. tostring(state and state.archetype)
    .. " stored_technology=" .. tostring(state and state.technology)
    .. " stored_level=" .. tostring(state and state.technology_level)
    .. " stored_progress=" .. tostring(state and state.research_progress))
  ...
  local force = game.forces.player
  local tech = technology()
  log("[mir-fixture] upgraded research archetype=" .. archetype
    .. " technology=" .. profile.technology
    .. " level=" .. tostring(tech.level)
    .. " current=" .. tostring(force.current_research and force.current_research.name)
  ...
  log("[mir-fixture] 2.5.0 to 2.5.5 upgrade proof complete archetype=" .. archetype)
end)
