...
local function fail(message)
  error("MIR 3.2.3 to 3.2.5 " .. archetype .. " upgrade validation failed: " .. message)
end
...
script.on_configuration_changed(function()
  if script.active_mods["more-infinite-research"] ~= "3.2.5" then
    fail("upgraded save did not use MIR 3.2.5")
  end
  ...
  if archetype == "base-continuations" and current_research_unit_count ~= state.research_unit_count then
    fail("neutral 3.2.5 base-continuation controls changed the 3.2.3 realized cost from "
  ...
  log("[mir-fixture] 3.2.3 to 3.2.5 upgrade proof complete archetype=" .. archetype
    .. " progress=" .. tostring(force.research_progress)
...
script.on_load(function()
  if storage.mir_upgrade_fixture and storage.mir_upgrade_fixture.upgrade_complete then
    log("[mir-fixture] 3.2.5 upgraded save reload proof complete archetype=" .. archetype)
  end
end)
