local from_version = "1.5.0"
local to_version = "1.5.9"
...
local function fail(message)
  error("MIR 1.5.0 to 1.5.9 retention validation failed: " .. message)
end
...
script.on_init(function()
  ...
  global.mir.target_upgrade_fixture = {
    ...
    runtime_marker = "factorio-0.15-global-state"
  }
  game.server_save("mir-1.5.0-save")
  log("[mir-fixture] 1.5.0 upgrade source proof complete")
end)
...
script.on_configuration_changed(function()
  ...
  if not state or state.runtime_marker ~= "factorio-0.15-global-state" then
  ...
  log("[mir-fixture] 1.5.0 to 1.5.9 upgrade proof complete")
end)
