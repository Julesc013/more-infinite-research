local from_version = "1.6.5"
local to_version = "1.6.9"
...
local function fail(message)
  error("MIR 1.6.5 to 1.6.9 retention validation failed: " .. message)
end
...
script.on_init(function()
  ...
  game.server_save("mir-1.6.5-save")
  log("[mir-fixture] 1.6.5 upgrade source proof complete")
end)
...
script.on_configuration_changed(function()
  ...
  log("[mir-fixture] 1.6.5 to 1.6.9 upgrade proof complete")
end)
