...
if mir_family_enabled("logistic-trash-slots", 1) then
  table.insert(mir_technologies, {
    type = "technology",
    name = "mir-logistic-trash-slots-1",
    ...
    upgrade = true,
    order = "z[mir]-logistic-trash-slots-01"
  })
end
if mir_family_enabled("logistic-trash-slots", 2) then
  table.insert(mir_technologies, {
    type = "technology",
    name = "mir-logistic-trash-slots-2",
    icon = "__base__/graphics/technology/character-logistic-trash-slots.png",
    effects = {
      {
        type = "character-logistic-trash-slots",
    ...
    prerequisites = {"mir-logistic-trash-slots-1"},
    unit = {
      count = 900,
      ingredients = {
      {"science-pack-1", 1},
    ...
    upgrade = true,
    order = "z[mir]-logistic-trash-slots-02"
  })
end
if mir_family_enabled("logistic-trash-slots", 3) then
  table.insert(mir_technologies, {
    type = "technology",
    name = "mir-logistic-trash-slots-3",
    icon = "__base__/graphics/technology/character-logistic-trash-slots.png",
    effects = {
      {
        type = "character-logistic-trash-slots",
    ...
    prerequisites = {"mir-logistic-trash-slots-2"},
    unit = {
      count = 1200,
      ingredients = {
      {"science-pack-1", 1},
    ...
    upgrade = true,
    order = "z[mir]-logistic-trash-slots-03"
  })
end
