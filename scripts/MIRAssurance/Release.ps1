...
function Invoke-MIRAssuranceCheckSeal {
  ...
  $checks.evidence_sha256=((Test-Path -LiteralPath $summaryPath -PathType Leaf) -and ((Get-MIRAssuranceSha256 -Path $summaryPath) -eq [string]$seal.qualification_summary_sha256))
