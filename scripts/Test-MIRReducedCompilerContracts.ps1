...
if ([string]$info.factorio_version -notin @("0.15", "0.16", "0.17", "0.18", "1.0", "1.1")) {
  throw "Reduced compiler contracts apply only to the maintained Factorio 0.15-1.1 lines."
}
