...
if ([string]$info.factorio_version -notin @("0.14", "0.15", "0.16", "0.17", "0.18", "1.0", "1.1")) {
  throw "Reduced compiler contracts apply only to the maintained Factorio 0.14-1.1 lines."
}
...
$baseExtensionMarkers = if ([string]$info.factorio_version -eq "0.14") {
...
if ([string]$info.factorio_version -eq "0.14") {
  $contracts += @(
