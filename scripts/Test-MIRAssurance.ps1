...
foreach ($path in @(
  ...
  ".mir/evidence/lower-wave/1.5.5-feature-classification.json"
)) {
...
if (@($evidenceClass[0].patterns | Where-Object { ".mir/evidence/lower-wave/1.5.5-feature-classification.json" -match [string]$_ })) {
