...
Invoke-RepoCheck "science-pack progression settings are wired" {
  ...
  $requiredSnippets = @(
    ...
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'mir-automatic-productivity-action=[font=default-bold][color=green]Main:[/color][/font] Automatic mod recipe support' },
    ...
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'This affects only new research creation; it never blocks safe attachment to existing research.' },
