...
Invoke-RepoCheck "science-pack progression settings are wired" {
  ...
  $requiredSnippets = @(
    ...
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'mir-automatic-compiler-mode=[font=default-bold][color=green]Main:[/color][/font] Mod recipe productivity coverage' },
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'mir-automatic-compiler-mode-safe-attach=Existing Research (Recommended)' },
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'mir-automatic-compiler-mode-exact-pack=Existing + Approved Packs' },
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'mir-automatic-compiler-mode-safe-generate=Existing + Assembler/Lab' },
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'mir-automatic-compiler-mode=Chooses one preset for adding productivity research to recipes from other mods. Options are ordered from no automatic changes to the broadest coverage; this is not a strength or experimental-level scale.' },
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'mir-automatic-compiler-mode-safe-attach=Recommended. Automatic changes: adds only safety-proven mod recipes' },
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'mir-automatic-compiler-mode-exact-pack=Automatic changes: Existing Research, plus a new productivity technology only when an active MIR compatibility pack matches the exact installed mod version' },
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'mir-automatic-compiler-mode-safe-generate=Broadest preset. Automatic changes: Existing Research, plus MIR may create the predeclared Assembling Machine Manufacturing and Lab Manufacturing productivity lines' },
