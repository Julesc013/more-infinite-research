...
$isReducedLegacyLine = $isFactorio018Line -or $isFactorio11Line
...
Invoke-RepoCheck "science-pack progression settings are wired" {
  ...
  $requiredSnippets = @(
    ...
    @{ File = "fixtures\assert-generation-integrity\data-final-fixes.lua"; Text = $generationIntegrityFixtureText; Snippet = 'assert_tech_uses_technology_icon("recipe-prod-research_lab_productivity-1", "mining-productivity-4")' },
    ...
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'laboratory-productivity=Lab research productivity: +__1__' },
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'worker-robot-battery=Worker robot battery: +__1__' },
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'character-inventory-slots-bonus=Character inventory slots: +__1__' },
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'character-logistic-trash-slots=Character logistic trash slots: +__1__' },
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'character-crafting-speed=Character crafting speed: +__1__' },
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'character-mining-speed=Character mining speed: +__1__' },
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'character-running-speed=Character walking speed: +__1__' },
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'character-reach-distance=Character reach distance: +__1__' },
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'character-build-distance=Character build distance: +__1__' },
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'character-resource-reach-distance=Character resource reach distance: +__1__' },
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'character-item-drop-distance=Character item drop distance: +__1__' },
