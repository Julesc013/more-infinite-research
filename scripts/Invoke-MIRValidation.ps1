...
Invoke-RepoCheck "science-pack progression settings are wired" {
  ...
  $requiredSnippets = @(
    ...
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'mir-automatic-productivity-action=[font=default-bold][color=green]Main:[/color][/font] Automatic productivity support' },
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'mir-automatic-create-research=[font=default-bold][color=green]Main:[/color][/font] Create research when needed' },
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'mir-automatic-require-reviewed-data=[font=default-bold][color=green]Main:[/color][/font] Require reviewed compatibility data' },
    ...
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'mir-automatic-productivity-action-apply=Apply Safe Changes (Recommended)' },
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'This is an action choice, not a strength or experimental scale.' },
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'It never invents a technology for every mod or recipe and cannot bypass safety gates.' },
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'Unsafe or ambiguous candidates are still skipped.' },
