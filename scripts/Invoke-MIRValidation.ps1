...
Invoke-RepoCheck "science-pack progression settings are wired" {
  ...
  $requiredSnippets = @(
    ...
    @{ File = "settings.lua"; Text = $settingsText; Snippet = 'local function stream_order_prefix(key, stream)' },
    @{ File = "settings.lua"; Text = $settingsText; Snippet = 'local bucket = default_enabled(key, stream) and "100" or "000"' },
    @{ File = "settings.lua"; Text = $settingsText; Snippet = 'local function base_order_prefix(spec, defaults_spec)' },
    @{ File = "settings.lua"; Text = $settingsText; Snippet = 'local bucket = defaults_spec.enabled == false and "000" or "100"' },
    ...
    @{ File = "locale\en\more-infinite-research.cfg"; Text = $localeText; Snippet = 'mir-debug-generation-report=Show generation diagnostics' },
