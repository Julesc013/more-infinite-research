...
foreach ($field in @("branch", "release", "target_factorio", "canonical_dev_anchor", "backport_source_lock_sha256", "canonical_feature_model_sha256", "target_profile_sha256", "target_reconstruction_profile_sha256", "canonical_target_catalog_sha256", "validation_harness_fingerprint", "factorio_binary_sha256", "qualification_summary_sha256")) {
