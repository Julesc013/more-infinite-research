...
$contracts = [ordered]@{
  ...
  "upgrade-proof.schema.json" = @("schema", "status", "package_source_commit", "evidence_commit", "factorio_binary_version", "factorio_binary_sha256", "from", "to", "assertions", "create_log", "create_log_sha256", "load_log", "load_log_sha256")
}
