...
MIR 1.4.5 is the Factorio 0.14 finite-substitute projection of the MIR 3.2.5 research-cost model. The canonical model is compiled into a positive bounded first-continuation count; unsupported infinite formulas and curve-selection controls remain omitted.
