...
MIR 1.5.5 is the Factorio 0.15 target-native projection of the MIR 3.2.5 research-cost model. Retained technologies support fixed, linear, exponential, and hybrid continuation costs without importing newer engine, DLC, recipe-productivity, settings-profile, or modern adoption systems.
