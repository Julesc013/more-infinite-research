...
More Infinite Research is a Factorio mod. The 3.x direction is a modular
compatibility compiler for infinite research technologies.
...
- Do not put docs, fixtures, scripts, tests, `.mir`, `.codex`, `.github`,
  `build`, `dist`, `AGENTS.md`, `CONTRIBUTING.md`, or `todo.md` in the release
  zip.
...
Run the narrowest relevant validation first, then the broader gate before a
release.
