# More Infinite Research 1.9.5

More Infinite Research 1.9.5 is the maintained Factorio 1.1 release.

It is a reduced target-native projection of the MIR 3.2.5 research-cost model. It preserves the eleven supported Factorio 1.1 research streams without importing Space Age, `mod-data`, settings-profile, or modern adoption systems.
