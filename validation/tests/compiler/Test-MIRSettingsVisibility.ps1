...
$streamDefaultsText = Read-MIRText -RelativePath "docs/reference/generated/stream-defaults.md"
...
if (-not $isReducedLegacyLine) {
  ...
  Assert-Contains -RelativePath "fixtures/assert-hidden-setting-readability/data-final-fixes.lua" -Text $fixtureText -Needle '"research_capture_robot_rockets"'
  Assert-Contains -RelativePath "fixtures/assert-hidden-setting-readability/data-final-fixes.lua" -Text $fixtureText -Needle '"research_nutrients"'
  Assert-Contains -RelativePath "fixtures/assert-hidden-setting-readability/settings-final-fixes.lua" -Text $fixtureSettingsText -Needle "assert_stream_enabled_by_default"
...
Assert-Contains -RelativePath "docs/reference/generated/stream-defaults.md" -Text $streamDefaultsText -Needle '<!-- BEGIN GENERATED MIR STREAM DEFAULTS -->'
Assert-Matches -RelativePath "docs/reference/generated/stream-defaults.md" -Text $streamDefaultsText -Pattern 'research_character_reach[^\r\n]*Yes'
Assert-Matches -RelativePath "docs/reference/generated/stream-defaults.md" -Text $streamDefaultsText -Pattern 'research_cargo_landing_pad_count[^\r\n]*Yes'
Assert-NoPattern -RelativePath "docs/reference/generated/stream-defaults.md" -Text $streamDefaultsText -Pattern 'research_cargo_landing_pad_count[^\r\n]*No'
Assert-NoPattern -RelativePath "docs/reference/generated/stream-defaults.md" -Text $streamDefaultsText -Pattern 'research_character_reach[^\r\n]*No'
