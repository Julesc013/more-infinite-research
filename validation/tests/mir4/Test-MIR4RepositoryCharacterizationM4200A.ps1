...
Assert-MIR4CharacterizationV1 (@($package.files|Where-Object{[string]$_.path -ceq 'README.md'}).Count -eq 1) 'mir4-characterization-readme-membership'
Assert-MIR4CharacterizationV1 ([string]$package.root_readme.disposition -ceq 'byte-stable-pending-m41-05b-package-documentation-separation') 'mir4-characterization-readme-disposition'
