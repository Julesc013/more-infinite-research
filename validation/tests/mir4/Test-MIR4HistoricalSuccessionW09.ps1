...
if(@($witness.changed_package_roots).Count-ne 14-or-not$witness.append_only-or$witness.prior_release_evidence_mutated-or-not$witness.published_predecessor.evidence_valid_for_predecessor-or$witness.evidence_disposition.c35_revoked-or$witness.evidence_disposition.transferable_to_mir4-or[string]$witness.published_predecessor.package_source_sha256-cne'FFF55368B65766D29049DF8E4DC845B38A6D4A65F1512EE62D277AD796181F89'-or[string]$witness.current_mir4.package_source_sha256-cne'9EFA2BBF5D399CCB6CE78BC907C5051D48E2CDB3DE652BA423FAF95FCE67A24C'){throw '[mir4-w09-succession-witness]'}
foreach($blocker in @('BLOCKED-HUMAN-SECRET-INPUT','BLOCKED-INDEPENDENT-PRODUCTION-CONSUMER','BLOCKED-EXACT-TARGET-PROCESSIR-SNAPSHOT','BLOCKED-MUSEUM-RIGHTS-CUSTODY-RESTORE-CLOSURE','BLOCKED-FUTURE-INDEPENDENT-PRODUCTION-HOST')){if($blocker-notin@($successorA.blockers)){throw "[mir4-w09-blocker] $blocker"}}
