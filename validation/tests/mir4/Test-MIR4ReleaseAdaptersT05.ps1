...
$expectedPostReleaseProfile=@('docs.check','tooling.self-test','static.package','static.branch-policy','static.mir4-release-adapters-t05','static.mir4-release-narratives-m41-03','static.mir4-repository-characterization-m42-00a')
