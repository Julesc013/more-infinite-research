...
### Optional v1.9.6/v1.9.7 Legacy Feedback Patch

- [ ] Backport bounded `v2.1.5` fixes only if they are useful to Factorio `2.0` players.
- [ ] Keep `v1.9.9` reserved for the final planned Factorio `2.0` port.
