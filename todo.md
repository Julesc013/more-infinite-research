...
<!-- MIR legacy RC plan start: tmp/0.16 -->
### `tmp/0.16` Factorio `0.16` RC Planning
...
- [x] Add `docs/notes/rc-plan-factorio-0.16.md` for the target-line API/code/docs audit.
- [ ] Read docs/notes/rc-plan-factorio-0.16.md before any implementation change on tmp/0.16.
- [ ] Keep tmp/0.16 documentation-only until a target implementation pass is explicitly started.
- [ ] Use factorio-data tag 0.16.51 and the report source links as first compatibility contract.
- [ ] Close unsupported-surface blockers before creating an RC package.
- [ ] Validate with a real Factorio 0.16.x binary or document the missing binary before public archive.
- [ ] After 1.9.9, fold durable findings into permanent legacy and delete tmp/0.16 only when remote refs are no longer needed.
- [ ] Build old-science resolver for 0.15/0.16.
- [ ] Decide whether character inventory capacity is omitted or separately proven.
<!-- MIR legacy RC plan end: tmp/0.16 -->
