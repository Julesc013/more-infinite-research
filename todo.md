...
<!-- MIR legacy RC plan start: tmp/0.17 -->
### `tmp/0.17` Factorio `0.17` RC Planning
...
- [x] Add `docs/notes/rc-plan-factorio-0.17.md` for the target-line API/code/docs audit.
- [ ] Read docs/notes/rc-plan-factorio-0.17.md before any implementation change on tmp/0.17.
- [ ] Keep tmp/0.17 documentation-only until a target implementation pass is explicitly started.
- [ ] Use factorio-data tag 0.17.79 and the report source links as first compatibility contract.
- [ ] Close unsupported-surface blockers before creating an RC package.
- [ ] Validate with a real Factorio 0.17.x binary or document the missing binary before public archive.
- [ ] After 1.9.9, fold durable findings into permanent legacy and delete tmp/0.17 only when remote refs are no longer needed.
- [ ] Create a 0.17 science/prerequisite map.
- [ ] Add a 0.17 load-only validation profile before implementation.
<!-- MIR legacy RC plan end: tmp/0.17 -->
