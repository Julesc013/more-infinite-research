...
<!-- MIR legacy RC plan start: tmp/0.12 -->
### `tmp/0.12` Factorio `0.12` RC Planning
...
- [x] Add `docs/notes/rc-plan-factorio-0.12.md` for the target-line API/code/docs audit.
- [ ] Read docs/notes/rc-plan-factorio-0.12.md before any implementation change on tmp/0.12.
- [ ] Keep tmp/0.12 documentation-only until a target implementation pass is explicitly started.
- [ ] Use factorio-data tag 0.12.35 and the report source links as first compatibility contract.
- [ ] Close unsupported-surface blockers before creating an RC package.
- [ ] Validate with a real Factorio 0.12.x binary or document the missing binary before public archive.
- [ ] After 1.9.9, fold durable findings into permanent legacy and delete tmp/0.12 only when remote refs are no longer needed.
- [ ] Confirm whether factorio_version should be explicit or rely on 0.12 default.
- [ ] Load a one-tech fixture in 0.12.35.
<!-- MIR legacy RC plan end: tmp/0.12 -->
