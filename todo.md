...
- MIR 3.1.5 is rebuilding after the final settings-availability correction; automated requalification, synchronization, interactive review, and human publication remain pending.
...
- [ ] Requalify the complete 91-scenario Factorio 2.1 matrix and deterministic exact-package gates after the final settings-availability correction.
- [ ] Re-run exact 3.0.5 and 3.1.2 upgrades against the corrected final 3.1.5 archive.
- [ ] Re-run all nine available exact-archive ecosystem loads against the corrected final archive.
