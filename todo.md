...
- MIR 2.4.5 is active on `tmp/2.0` as the disabled-prerequisite startup-safety hotfix.
...
2. [ ] Rebuild and rerun version-sensitive exact-archive, upgrade, freshness, and seal checks for 2.4.5.
