...
| `M41-08` | `4.1.0` | `active` | M41-07 | Freeze, build, qualify, seal, and promote the private four-target MIR 4.1 candidate to exact main readiness with only the human playtest gate remaining |
| `M43-00` | `4.2.0` | `blocked-dependency` | M41-08, M42-01, M42-02 | Admit integration-kernel and built-in ecosystem capabilities through exact contracts |
