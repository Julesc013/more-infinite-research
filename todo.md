...
<!-- MIR legacy RC plan start: tmp/0.13 -->
### `tmp/0.13` Factorio `0.13` RC Planning
...
- [x] Add `docs/notes/rc-plan-factorio-0.13.md` for the target-line API/code/docs audit.
- [ ] Read docs/notes/rc-plan-factorio-0.13.md before any implementation change on tmp/0.13.
- [ ] Keep tmp/0.13 documentation-only until a target implementation pass is explicitly started.
- [ ] Use factorio-data tag 0.13.20 and the report source links as first compatibility contract.
- [ ] Close unsupported-surface blockers before creating an RC package.
- [ ] Validate with a real Factorio 0.13.x binary or document the missing binary before public archive.
- [ ] After 1.9.9, fold durable findings into permanent legacy and delete tmp/0.13 only when remote refs are no longer needed.
...
<!-- MIR legacy RC plan end: tmp/0.13 -->
