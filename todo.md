...
| `325-B0` first complete compatibility slice | Next product slice; not yet admitted | Research-cost default parity traced through disposition, typed proof, bounded support output, and exact Factorio 2.0 disposition |
