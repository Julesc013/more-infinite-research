...
function New-A08Qualification {
  ...
  $presentationPath='spec/distribution/mir4-current-package-presentation-v7.json'
...
'@
  ...
  $manifest=[pscustomobject][ordered]@{schema=3;kind='MIR4ComposablePackageSourceV3';record_sha256=''}
  ...
  $presentation=[pscustomobject][ordered]@{
    schema=1
    kind='MIR4CurrentPackagePresentationV7'
  ...
  Write-A08Json (Join-Path $testRoot 'spec/distribution/mir4-current-package-presentation-v7.json') $presentation
