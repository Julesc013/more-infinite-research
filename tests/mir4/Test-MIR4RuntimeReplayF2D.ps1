...
$files = @(
  ...
  'tools/mir/cli/Invoke-MIR4PackageSource.ps1','tests/runtime/Test-MIRUpgrade.ps1',
  'tests/runtime/Test-MIRUpgradeMatrix.ps1','tools/commands/mir4/Update-MIR4M41F2DTargetRuntimeReplayAuthority.ps1','tools/commands/mir4/Update-MIR4M41F2DFourTargetRuntimeReplayAggregate.ps1','tools/mir/application/package/RuntimeReplayAggregateVerifier.ps1','tools/mir.ps1'
)
...
$runnerText = Get-Content -Raw -LiteralPath (Join-Path $RepoRoot 'tests/runtime/Test-MIRUpgrade.ps1')
...
$matrixText = Get-Content -Raw -LiteralPath (Join-Path $RepoRoot 'tests/runtime/Test-MIRUpgradeMatrix.ps1')
