...
$postReleaseProfile=@($assurance.profiles.'mir4-post-release')
  $expectedPostReleaseProfile=@('docs.check','tooling.self-test','static.package','static.branch-policy','static.mir4-release-adapters-t05','static.mir4-release-narratives-m41-03','static.mir4-repository-characterization-m42-00a','static.mir4-golden-four-target-baseline-m41-f1','static.mir4-shadow-target-materializer-m41-f2a','static.mir4-shadow-source-model-m41-f2b','static.mir4-editable-source-materializer-m41-f2c','static.mir4-compilation-plan-decomposition-m42-02-l1','static.mir4-base-continuations-decomposition-m42-02-l2','static.mir4-stream-compiler-decomposition-m42-02-l3','static.mir4-technology-catalog-decomposition-m42-02-l4','static.mir4-factorio-2.1-experimental-channel','static.mir4-f2d-runtime-replay','static.mir4-pre-freeze-hardening')
