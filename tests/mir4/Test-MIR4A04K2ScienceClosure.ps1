...
function Resolve-A04ClosurePath { param([string]$Relative,[bool]$File=$true)
  ...
  if($File -and $Relative -cmatch '^(?:src/mod|targets/(?:f100|f110|f200|f210)/files)/'){
...
Assert-A04Closure ([string]$closure.patch_eligibility.k2_request.canonical_sha256 -ceq '6C6F6AC035A408E68FEDF8ED7712A989BE464722DCBAAFD5F82D1A5AE04AE039') '[mir4-a04-closure-historical-k2-request]'
Assert-A04Closure ([string]$closure.patch_eligibility.delivery_rule.canonical_sha256 -ceq 'D1A0C60073A419A19048FA059E3274B38A7508DD398954E1399E97D030AB2559') '[mir4-a04-closure-historical-delivery-rule]'
