...
Assert-MIR4RepositoryMigrationV1 (@($authority.migration_sequence).Count -eq 7) 'mir4-repository-migration-sequence-count'
...
Assert-MIR4RepositoryMigrationV1 ([string]$authority.migration_sequence[6].migration_id -ceq 'MIR4-TARGET-COMPILER-TOOLING-V1' -and [string]$authority.migration_sequence[6].state -ceq 'current-append-only-successor') 'mir4-repository-migration-sequence-successor'
