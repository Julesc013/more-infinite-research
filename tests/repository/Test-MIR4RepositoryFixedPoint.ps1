                          ...
                          if(Test-Path -LiteralPath (Join-Path $repo $m4202CompatibilityAuditPath) -PathType Leaf){
                            ...
                            if(Test-Path -LiteralPath (Join-Path $repo $m4202OfflineCustodyPath) -PathType Leaf){
                              ...
                              if(Test-Path -LiteralPath (Join-Path $repo $m4202ReleaseCapsulePath) -PathType Leaf){
                                ...
                                Assert-MIR4RepositoryMigrationV1 ([string]$m4202ReleaseCapsule.preservation.package_source_sha256-ceq$currentPackageSourceSha256-and@($m4202ReleaseCapsule.preservation.package_visible_delta).Count-eq0) 'mir4-repository-migration-m42-02-release-capsule-package-firewall'
                                ...
                                if(Test-Path -LiteralPath (Join-Path $repo $m4202ControlExecutorPath) -PathType Leaf){
                                  ...
                                  Assert-MIR4RepositoryMigrationV1 ([string]$m4202ControlExecutor.preservation.package_source_sha256-ceq$currentPackageSourceSha256-and@($m4202ControlExecutor.preservation.package_visible_delta).Count-eq0) 'mir4-repository-migration-m42-02-control-executor-package-firewall'
                                  ...
                                  if(Test-Path -LiteralPath (Join-Path $repo $m4202SupplyChainPath) -PathType Leaf){
                                    ...
                                    Assert-MIR4RepositoryMigrationV1 ([string]$m4202SupplyChain.preservation.package_source_sha256-ceq$currentPackageSourceSha256-and@($m4202SupplyChain.preservation.package_visible_delta).Count-eq0) 'mir4-repository-migration-m42-02-supply-chain-package-firewall'
