...
Assert-MIR4RepositoryMigrationV1 (@($authority.migration_sequence).Count -eq 6) 'mir4-repository-migration-sequence-count'
...
Assert-MIR4RepositoryMigrationV1 ([string]$authority.migration_sequence[5].migration_id -ceq 'MIR4-TECHNOLOGY-ACCEPTANCE-TOOLING-V1' -and [string]$authority.migration_sequence[5].state -ceq 'current-append-only-successor') 'mir4-repository-migration-sequence-successor'
