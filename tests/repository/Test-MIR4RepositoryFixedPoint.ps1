...
Assert-MIR4RepositoryMigrationV1 (@($authority.migration_sequence).Count -eq 21) 'mir4-repository-migration-sequence-count'
...
Assert-MIR4RepositoryMigrationV1 ([string]$authority.migration_sequence[20].migration_id -ceq 'MIR4-M41-TO-M42-COMPOSABLE-SOURCE-SUCCESSION-V3' -and [string]$authority.migration_sequence[20].authority -ceq 'spec/distribution/mir4-current-package-presentation-v5.json' -and [string]$authority.migration_sequence[20].receipt -ceq 'assurance/repository/mir4-m41-to-m42-composable-source-succession-v3.json' -and [string]$authority.migration_sequence[20].state -ceq 'current-append-only-successor') 'mir4-repository-migration-sequence-progression-successor'
