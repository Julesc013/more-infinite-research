...
try {
  ...
  & (Join-Path $RepoRoot "tests\compiler\Test-MIRTechnologyPromotionAdmission.ps1") `
  ...
  function Invoke-TamperedAdmission {
    ...
    & (Join-Path $RepoRoot "tests\compiler\Test-MIRTechnologyPromotionAdmission.ps1") @params
