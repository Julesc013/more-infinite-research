...
$harnessPaths = @(
  ...
  "tools\commands\museum\Build-MIRMuseumTarget.ps1", "tests\runtime\Test-MIRMuseumCompiler.ps1", "tests\runtime\Test-MIRMuseumRuntime.ps1",
  "tools\commands\museum\New-MIRMuseumQualification.ps1", "tools\commands\museum\New-MIRMuseumSeal.ps1", "tests\runtime\Test-MIRMuseumSeal.ps1"
)
