...
The current older-target state is MIR `1.9.4` qualified but unreleased on `tmp/1.1`, MIR `1.8.5` in local outage qualification on `candidate/1.8.5-projection`, MIR `1.7.1` planned on `tmp/0.17`, MIR `1.6.0` planned on `tmp/0.16`, and MIR `1.5.0` planned on `tmp/0.15`. MIR `1.8.2` remains the immutable Factorio 1.0 predecessor. Archived plans retain their historical version numbers; current 0.16 and 0.15 work follows the new 1.6.0 and 1.5.0 plans.
