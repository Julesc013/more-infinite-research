...
- Startup settings use visible Main, Compatibility, Prototype limits, Advanced,
...
- Optional prototype-limit dropdowns default to `Engine default` and only mutate recipe productivity, efficiency, speed, or quality caps when explicitly changed.
...
- Global startup settings are grouped with visible Main, Compatibility,
  Prototype limits, Advanced, and Diagnostics prefixes. Generated technology
