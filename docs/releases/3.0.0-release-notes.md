...
- Final package hygiene check found 114 entries and zero forbidden
...
- Local supported-zip isolation found `atan-ash_2.2.1` and
  `atan-nuclear-science_0.3.3` failing without MIR on the tested Factorio `2.1`
  setup. Those are tracked as upstream package/schema issues, not MIR
  regressions.
