---
title: "More Infinite Research 0.10.0 Release Notes"
status: current
applies_to: "0.10.0"
audience: player
...
MIR 0.10.0 is a finite historical edition for Factorio 0.10.12. It restores selected research bonus continuations using target-era prototypes and configuration.

## Fixed

- Added the required `"factorio_version": "0.10"` compatibility field to `info.json`.
- Rebuilt the deterministic release archive so metadata validators no longer report `factorio_version` as missing.
- Kept the mod version as `"version": "0.10.0"` and the dependency floor as `base >= 0.10.12`.
...
Use this release with Factorio 0.10.12. The archive is ZIP-native and can be placed directly in the target's mods directory.

## Validation

- Exact Factorio 0.10.12 build 10773 bounded fresh startup and second startup: passed.
...
- Release ZIP SHA-256: `C2E42E9AE23E4A146F755B60D40009738724E7A0D3670D3B672D2068AE80912E`.
