...
| Ice productivity | `+10%` productivity for oxide asteroid crushing and compatible ice recipes | On when recipes exist | Adds space and cryogenic science when available. |
...
| Breeding productivity | `+10%` productivity for raw fish, biter egg, pentapod egg, and cultivation/culture/breeding recipes except dedicated bacteria cultivation recipes | On when recipes exist | Adds agricultural and cryogenic science when available; honors Space Age's productivity-exempt pentapod seed egg and avoids broad biochamber category matching. |
| Nutrients productivity | `+10%` for exact yumako mash, bioflux, and biter egg nutrient recipes | On with Space Age | Excludes spoilage recovery, fish, ash sinks, and broad third-party matches. Adds agricultural and cryogenic science when available. |
| Capture bot rocket productivity | `+10%` for the exact capture robot rocket recipe | On with Space Age | Grants exact recipe productivity permission. Adds military and agricultural science when available. |
...
| Landfill productivity | `+10%` for landfill; `+5%` for foundation | On when recipes exist | Uses landfill technology art and adds metallurgic and space science when available. |
| Platform productivity | `+10%` for ice platform; `+5%` for space platform foundation | On when recipes exist | Grants exact productivity permission to both Space Age platform recipes. Uses Landfill's progression with cryogenic science replacing metallurgic science. |
