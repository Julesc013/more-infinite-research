...
P11 is an unreleased, locally automated-qualified and manually accepted candidate. All 126 machine-verifiable tasks pass against the exact archive, including exact runtime, upgrade, ecosystem, approved-delta, AdvancedBeltsSA, and six-lane paired performance evidence. The schema-2 maintainer attestation binds the same exact archive, content, package source, and Factorio 2.0.77 binary. Protected qualification, seal verification, promotion, tagging, and publication remain pending. P9 and P10 results remain superseded historical evidence and are not current P11 proof.
