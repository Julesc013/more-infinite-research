...
`docs/archive/superseded/2.2.0-feature-intake.md`. Its useful input is the feature-family risk
...
The expanded older-line ladder is recorded as historical context in `docs/archive/superseded/legacy-backport-cadence.md`.
