...
| Factorio 2.1 | 3.1.5 | `dev` | Modular compiler-control source pending | Rebuilding | Previous evidence invalidated by package-visible source, settings, locale, fixture, and documentation changes | Candidate rebuilding | Automated qualification |
...
1. Freeze the completed portable-return sweep and modular compiler-control source as untagged MIR 3.1.5 on `dev`.
