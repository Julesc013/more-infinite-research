...
| Factorio 2.0 | 2.4.1 | `tmp/2.0` | `f42b45d` package source plus `79df29b` regression | `7931E97D...AAC3D` | Focused regression and exact-dist base/Space Age loads passed on Factorio 2.0.77 | Sealed release candidate | Maintainer review, tag, and release |
