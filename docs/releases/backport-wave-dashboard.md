...
| Factorio 2.1 | 3.1.5 | `dev` | Settings UX source pending | Rebuilding | Previous evidence invalidated by package-visible locale changes | Candidate rebuilding | Automated qualification |
