...
| Factorio 2.1 | 3.1.5 | `dev` | `bbc6b49` qualified source | `493F6EE2...9EA` | 91 scenarios, exact 3.0.5 upgrade, ecosystem 9/9, deterministic exact dist, and zero forbidden entries passed | Candidate qualified | Manual release decision |
