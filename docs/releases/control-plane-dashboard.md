...
| --- | --- | --- | --- | --- | --- | --- | ---: |
| `3.2.9` | `not-assigned` | `C / 33` | `2.1` | `main` | `planned` | `planned` | 0 |
...
| `2.5.9` | `not-assigned` | `2.5-P / 13` | `2.0` | `legacy` | `planned` | `planned` | 0 |
