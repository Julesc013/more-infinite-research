...
Static package validation also compares key packaged source, documentation, locale files, and binary graphics assets against the repository copy so a stale zip with correct metadata is rejected.
