...
The split preserves the exact canonical 85-command public projection. Internal module placement grants no independent public entrypoint, package writer, runtime, migration, release, signing, sealing, or publication authority. New public commands still require command-inventory and CLI-contract evolution; adding a function to a router module does not expose it automatically.
