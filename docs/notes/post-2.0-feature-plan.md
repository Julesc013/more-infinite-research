...
After v1.9.2, use docs/notes/target-line-versioning-and-backports.md for the target-line versioning reset.
```
...
Post-transition MIR v3.x.x on Factorio 2.1.x -> MIR v2.x.x on Factorio 2.0.x starting at v2.5.0
```
