...
| `atan-air-scrubbing` | Supported in `2.1.5` after final gate | MIR-owned productivity for clean pollution and spore filter recipes only | Static and runtime fixture plus targeted external load pass | Does not touch scrubbing or cleaning recipes; pollution/spore removal efficiency is not a MIR core feature. |
