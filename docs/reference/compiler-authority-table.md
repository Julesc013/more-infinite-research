...
| ResearchCostCompatibilitySlice | 1 | `prototypes/mir/domain/research_cost/compatibility_slice.lua` | research-cost model test and compiler-contract fixture | terminal neutral-default disposition, typed proof, bounded support, and target projection |
...
| Runtime scenario declaration | 3 | `validation/scenarios/runtime.json` | `tools/lib/validation/ScenarioRegistry.ps1` | validation harness |
