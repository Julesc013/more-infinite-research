...
| `4.1` | `repository-and-authority-fixed-point` | mixed | append-only-repository-canonicalization-diagnostics-and-target-key-tool-and-test-writer-cutovers-with-compatibility-readers | remaining-repository-authority-families, package-visible-source-cutover-parity-and-independent-acceptance |
