...
| `4.1` | `repository-and-authority-fixed-point` | mixed | append-only-repository-through-historical-succession-application-cli-and-test-writer-cutovers-with-compatibility-readers | remaining-repository-authority-families, package-visible-source-cutover-parity-and-independent-acceptance |
...
| `4.13` | `offline-inspector-workbench` | preview | implemented-offline-preview-canonical-application-cli-and-test-cutover | BLOCKED-INDEPENDENT-PRODUCTION-CONSUMER |
| `4.14` | `compatibility-factory-and-support-assessment` | preview | implemented-data-only-preview-canonical-application-cli-and-test-cutover | none |
...
| `4.16` | `historical-museum-and-successor-host` | mixed | private-historical-plus-blocked-museum-plus-synthetic-host-canonical-tooling-migrated | BLOCKED-MUSEUM-CUSTODY, BLOCKED-FUTURE-INDEPENDENT-PRODUCTION-HOST |
