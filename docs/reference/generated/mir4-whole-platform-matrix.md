...
| `4.1` | `repository-and-authority-fixed-point` | mixed | append-only-repository-canonicalization-diagnostics-target-key-and-whole-platform-application-and-test-writer-cutovers-with-compatibility-readers | remaining-repository-authority-families, package-visible-source-cutover-parity-and-independent-acceptance |
