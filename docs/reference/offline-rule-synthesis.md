...
```powershell
.\tools\commands\technology\Invoke-MIRRuleSynthesis.ps1 -Family mining-drill-manufacturing -OutputPath out\mining-drill-proposal.json
```
