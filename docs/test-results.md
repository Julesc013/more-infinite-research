...
- Updated roadmap, TODO, README, compatibility notes, changelog, mod-portal copy, and release notes for the immediate `2.1.0 -> 1.9.5` cadence.
...
- Release archive built: `dist/more-infinite-research_1.9.5.zip`.
